    ...
    <>
      <Modal open={open} onClose={onClose}>
        ...
        >
          ...
          <Grid item>
            <Typography variant="body1">
              Ele desconsidera outros elementos que costumam fazer parte do
              valor total das faturas como: tributos, encargos setoriais,
              bandeiras tarifárias e cobranças adicionais, já que dificultariam
              a análise.
            </Typography>
          </Grid>
          <Grid item>
